//-----------------------------------------------------------------------------
// SimpleController.h
// Provides a simple way to query input from keyboard+mouse and/or controllers
// via XINPUT.
//-----------------------------------------------------------------------------
...
public:
  ...
  virtual bool CheckButton(const App::GamepadButton button,
                           const bool onPress = true) const = 0;
...
public:
  ...
  virtual bool CheckButton(const App::GamepadButton button,
                           const bool onPress = true) const override;
