///////////////////////////////////////////////////////////////////////////////
// Filename: App.cpp
// Provides a number of basic helper functions that wrap around thing like
// rendering, sound, and input handling
///////////////////////////////////////////////////////////////////////////////
//---------------------------------------------------------------------------------
#include "app.h"
...
void DrawTriangle(const float p1x, const float p1y, const float p2x,
                  const float p2y, const float p3x, const float p3y,
                  const float r, const float g, const float b,
...
CSimpleSprite *CreateSprite(const char *fileName, const int columns,
                            const int rows) {
...
bool IsMousePressed(int button) { return Internal::IsMousePressed(button); }
...
void Print(const float x, const float y, const char *st, const float r,
           const float g, const float b, void *font) {
  float xPos = x;
  float yPos = y;
#if APP_USE_VIRTUAL_RES
...
#define HANDLE_ASCII_KEY(KEYCODE, KEY, MODIFIED_KEY)                           \
  case KEYCODE:                                                                \
    return Internal::IsKeyPressed(KEY) ||                                      \
           Internal::IsKeyPressed(MODIFIED_KEY);                               \
    break;
